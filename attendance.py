...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","Reg_No","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport_left.heading("Reg_No",text="Reg.No")
        ...
        self.attendanceReport_left.column("Reg_No",width=100)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","Reg_No","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport.heading("Reg_No",text="Reg.No")
        ...
        self.attendanceReport.column("Reg_No",width=100)
        ...
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set std_reg_no=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",(
                    self.var_roll.get(),
                    self.var_name.get(),
                    self.var_time.get(),
                    self.var_date.get(),
